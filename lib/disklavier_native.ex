defmodule DisklavierNative do
  ...
  import DisklavierWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {DisklavierWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([DisklavierWeb, CoreComponents, plugin.module_suffix])
